...
var Zones = function (_Component) {
	...
	_createClass(Zones, [{
		...
		value: function render() {
			var listItems = this.state.list.map(function (zone, index) {
...
var _Zones = __webpack_require__(14);
...
var Zone = function (_Component) {
	...
	_createClass(Zone, [{
		key: 'render',
		value: function render() {
			var styleZone = _styles2.default.zone;
...
var Comments = function (_Component) {
	...
	_createClass(Comments, [{
		...
		key: 'render',
		value: function render() {
			var listItems = this.state.list.map(function (comment, index) {
				return _react2.default.createElement(
					'li',
					{ key: index },
